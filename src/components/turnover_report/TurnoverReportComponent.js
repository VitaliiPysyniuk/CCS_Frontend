    ...
    return (
        ...
        <div className="position-relative">
            ...
            {reportVisible && <table className="table table-bordered t-36">
                <thead>
                <tr>
                    <th className="col-md-auto align-middle text-center p-1" rowspan="2" scope="col">Код</th>
                    <th className="col-md-3 align-middle text-center p-1" rowspan="2" scope="col">Назва</th>
                    <th className="col-md-1 align-middle text-center p-1" rowspan="2" scope="col">О-ця</th>
                    <th className="col-md-1 text-center p-1" colspan="3" scope="col">Прихід</th>
                    <th className="col-md-1 text-center p-1" colspan="3" scope="col">Розхід</th>
                    <th className="col-md-2 align-middle text-center p-1" rowspan="2" scope="col">На основі</th>
                </tr>
                <tr>
